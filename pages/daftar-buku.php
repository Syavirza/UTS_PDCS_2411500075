...
$kategori_per_buku = []; // Inisialisasi array untuk menyimpan kategori per buku
$sql_kategori = "
...
if($result_kategori) {
    // dia mappinng, idbuku & nama kategori
            ...
            <table class="table table-striped">
                            ...
                            <tbody>          
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $no ?></th>
                                    <td>
                                        <!-- disini judul dan cover dengan ukuran kecil -->
                                         <div class="d-flex align-items-center">
                                            ...
                                            <img src="uploads/" alt="Cover Buku" width="50" height="70" style="object-fit: cover; border-radius: 5px; margin-right: 10px" />
                                            <?php else : ?>
                                                <!-- jika tidak ada cover, tampilkan gambar default -->
                                    ...
                                    <td>
                                        <a href="index.php?hal=ubah-buku&id=<?php echo $row['id_buku'] ?>" class="btn btn-success btn-sm">Ubah</a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
